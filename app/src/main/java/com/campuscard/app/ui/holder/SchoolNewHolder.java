...
public class SchoolNewHolder extends IViewHolder {
    ...
    public class ViewHolder extends XViewHolder<NewsEntity> {
        ...
        @Override
        protected void onBindData(final NewsEntity itemData) {
            tvTitle.setText(itemData.getTitle());
            tvTime.setText(itemData.getOnlineTime());
