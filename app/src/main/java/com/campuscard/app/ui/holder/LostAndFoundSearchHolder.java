...
public class LostAndFoundSearchHolder extends IViewHolder {

    @Override
    protected XViewHolder create(View view, RecyclerView.Adapter adapter) {
        return new LostAndFoundSearchHolder.ViewHolder(view, adapter);
    }

    @Override
    public int getLayout() {
        return R.layout.item_lost_found_search;
    }
    ...
    public class ViewHolder extends XViewHolder<LostFoundEntity> {
        ...
        protected void onBindData(final LostFoundEntity itemData) {
            ...
            //标签
            if (itemData.getLostFoundType().equals("LOST")) {
                ivType.setImageResource(R.mipmap.ic_lost);
            } else {
                ivType.setImageResource(R.mipmap.ic_found);
            }
