...
public class XRoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(R.styleable.roundedimageview_border_thickness
                , 0);  //内外圆间距边距
        mBorderOutsideColor = a.getColor(R.styleable.roundedimageview_border_outside_color, defaultColor); //外圆颜色
        mBorderInsideColor = a.getColor(R.styleable.roundedimageview_border_inside_color, defaultColor);//内圆颜色
        mbackground = a.getColor(R.styleable.roundedimageview_in_background, 0);//背景色
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (drawable instanceof AsyncDrawable) { //解决xutils冲突
            b = Bitmap
                    .createBitmap(
                            getWidth(),
                            getHeight(),
        ...
        //画内圆
        if (mbackground != 0) {
            drawCircleInBorder(canvas, radius, mbackground);
        }
     ...
     * 内实心画圆
     */
    private void drawCircleInBorder(Canvas canvas, int radius, int color) {
        Paint paint = new Paint();
        /* 去锯齿 */
        paint.setAntiAlias(true);
        paint.setFilterBitmap(true);
