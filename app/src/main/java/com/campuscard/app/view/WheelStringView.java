 ...
 * 滚动控件
 */
public class WheelStringView extends View {
    ...
    public WheelStringView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
        initData();
    }

    public WheelStringView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        initData();
    }

    public WheelStringView(Context context) {
        super(context);
        initData();
    }
...
//                Log.d(TAG,"time="+time+",y - downY="+(y - downY));
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itemObject.setWork(dataList.get(i).toString());
            itemObject.x = 0;
...
//            if (y + move > controlHeight || ((float)y + (float)move + (float)unitHeight / 2 + (float)textRect.height() / 2f) < 0)
        ...
        public void setWork(String area) {
            this.area = area;
        }
    }
    ...
    public interface OnSelectListener {
         ...
         */
        void endSelect(int id, String areaProvEntity);
         ...
         * @param areaProvEntity
         */
        void selecting(int id, String areaProvEntity);
